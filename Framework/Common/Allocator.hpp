...
namespace My 
{
    ...
    struct PageHeader 
    {
        ...
        BlockHeader* Blocks() 
        {
                return reinterpret_cast<BlockHeader*>(this + 1);//reinterpret_cast Returns a value of type new_type. Type Cast
        }
    };
    ...
    class Allocator 
    {
        public:
                // debug patterns
                static const uint8_t PATTERN_ALIGN = 0xFC;// so how does thsi work
